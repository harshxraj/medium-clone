  ...
  return (
    <div
      className={
        ...
        " duration-700 max-sm:right-0 sm:top-0 w-[30%] sm:w-[300px] md:min-w-[500px] lg:min-w-[500px] h-full z-50 bg-white shadow-2xl p-8 px-16 overflow-y-auto overflow-x-hidden"
      }
    >
